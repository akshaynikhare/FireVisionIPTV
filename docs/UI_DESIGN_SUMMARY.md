# FireVision IPTV - Slox-Style Android TV App

## Design Brief
Android TV IPTV streaming app with Slox-inspired dark UI. Pure black (#000000) background, unique blue (#2196F3) accents, white (#FFFFFF) text. Built with Android Leanback library for TV D-pad navigation.

## Core Layout
**Vertical Sidebar (89dp width)**: Slox-style left navigation with 5 icons - Home, Search, Categories, Favorites, Settings. Dark background (#0A0A0A), focused items show lighter background (#1A1A1A).
